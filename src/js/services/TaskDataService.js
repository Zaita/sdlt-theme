...
query {
  ...
  readServiceInventory {
    ...
    const data: TaskSubmission = {
      ...
      isBusinessOwner: get(submissionJSONObject, "QuestionnaireSubmission.IsBusinessOwner", "false") === "true" || get(submissionJSONObject, "QuestionnaireSubmission.IsBusinessOwner", "false") === "1",
      ...
      isCurrentUserAnApprover:  get(submissionJSONObject, "IsCurrentUserAnApprover", "false") === "1" || get(submissionJSONObject, "IsCurrentUserAnApprover", "false") === "true",
      isTaskApprovalRequired: get(submissionJSONObject, "IsTaskApprovalRequired", false) === "1" || get(submissionJSONObject, "IsTaskApprovalRequired", false) === "true",
      ...
      isTaskCollborator: _.get(submissionJSONObject, "IsTaskCollborator", "false") === "1" || _.get(submissionJSONObject, "IsTaskCollborator", "false") === "true",
      isDisplayPreventMessage: _.get(submissionJSONObject, "IsDisplayPreventMessage", "false") === "1" || _.get(submissionJSONObject, "IsDisplayPreventMessage", "false") === "true",
