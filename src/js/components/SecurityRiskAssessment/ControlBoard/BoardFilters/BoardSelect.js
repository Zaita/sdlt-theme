  ...
  render() {
    ...
    return (
      <div className='board-select'>
        ...
        <Select SelectDisplayProps={{ style: { paddingTop: 9, paddingBottom: 9, fontSize: 'small' } }} className={addClass === 'sort-by' ? 'board-select-input sort-by' : 'board-select-input'} variant="outlined" defaultValue={filterParameters[0].title} onChange={this.handleChange}>
