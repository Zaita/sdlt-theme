...
export const EVALUATION_RATING_1 = 'Not Validated';
export const EVALUATION_RATING_2 = 'Not Effective';
export const EVALUATION_RATING_3 = 'Partially Effective';
export const EVALUATION_RATING_4 = 'Effective';
